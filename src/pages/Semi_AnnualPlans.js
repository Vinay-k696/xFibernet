...
export default function Semi_AnnualPlans() {
  ...
  return (
      <>
      <section className='semiAnnualPlans'>
          <div className='container'>
              {/* 6 Month Plans */}
        <div className='semi-annual'>
            <h1>Semi-Annual Plans</h1>
            <div className='p-wrapper'>
                <OwlCarousel {...SemiPlans}>
                <div className='p-card'>
                    ...
                    <div className='p-benfits'>
                        ...
                        <div className='p-validity'>
                            <span>Validity</span>
                            <h4> 180 Days </h4>
                            <small className='ex_benfit'>+30 Days Free</small>
                        </div>
                    </div>
          ...
          <div className='container'>
            ...
            <div className='moreinfo-container'>
                <div className='more-btn'>
                    <div>
                        <Link to="/Semi_AnnualPlans">
                        <button className='btn-more'>Semi-Annual Plans</button></Link>
                    </div>
                    <div>
                        <Link to="/AnnualPlans">
                        <button className='btn-more'>Annual Plans</button></Link>
                    </div>
                    <div>
                        <Link to="/">
                        <button className='btn-more'>AirFiber Plans</button></Link>
                    </div>
                    <div>
                        <Link to="/">
